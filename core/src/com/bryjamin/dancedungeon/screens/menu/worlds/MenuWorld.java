...
import com.bryjamin.dancedungeon.screens.PlayScreen;
import com.bryjamin.dancedungeon.screens.menu.WorldContainer;
...
public class MenuWorld extends WorldContainer {
    ...
    private void createWorld(){
        ...
        startButton.edit().add(new PositionComponent(CenterMath.offsetY(gameport.getWorldWidth(), width), CenterMath.offsetY(gameport.getWorldHeight(), height)));
        ...
        startButton.edit().add(new DrawableComponent(Layer.ENEMY_LAYER_MIDDLE,
                new TextureDescription.Builder(TextureStrings.BLOCK)
                        .width(width)
                        .height(height).build(),
                new TextDescription.TextDescriptionBuilder(FileStrings.DEFAULT_FONT_NAME)
                        .text("Start")
        ...
        TextDescription.TextDescriptionBuilder tb =(TextDescription.TextDescriptionBuilder) new TextDescription.TextDescriptionBuilder(FileStrings.DEFAULT_FONT_NAME)
                .text("Start")
                .color(new Color(Color.BLACK));
